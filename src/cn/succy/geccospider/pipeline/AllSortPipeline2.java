...
import cn.succy.geccospider.bean.AllSort2;
...
@PipelineName(value="allSort2Pipeline")
public class AllSortPipeline2 implements Pipeline<AllSort2>{
	public static FileOperate fileOperate = new FileOperate();
	private File file;
	@Override
	public void process(AllSort2 allSort) {
